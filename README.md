...
- `CHAT_AGENT_MAX_OUTPUT_TOKENS`: Optional chatbot response cap. Defaults to `2048`.
- `CHAT_AGENT_THINKING_BUDGET`: Optional Gemini thinking-token budget for WhatsApp text replies. Defaults to `0` to avoid short replies being cut by hidden thinking tokens.
