...
- Tightened the model-level multilingual/tool contract after the production quality gate exposed Sinhala hesitation and Tamil-to-Sinhala drift. Added protocol support for Gemma's native tool-call envelope without adding intent or property keyword routing, made generation deterministic, and capped it at 96 tokens. The GPU gate allows at most 12 seconds while the live pipeline gives the caller a progress line after 2.25 seconds.
