...
- Tightened the model-level multilingual/tool contract after the production quality gate exposed Sinhala hesitation and Tamil-to-Sinhala drift. Added protocol support for Gemma's native tool-call envelope without adding intent or property keyword routing, and capped generation at 96 tokens to keep one-sentence/tool responses within the live-call latency budget.
