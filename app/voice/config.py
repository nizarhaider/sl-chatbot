...
TURN_SILENCE_THRESHOLD = 1200
TURN_SPEECH_START_THRESHOLD = 1120
TURN_SPEECH_START_CHUNKS = 4  # 160 ms of sustained voice before opening a turn
...
TURN_END_SILENCE_CHUNKS = 32
TURN_MIN_AUDIO_MS = 640
...
TURN_BARGE_IN_RMS_THRESHOLD = 1760
TURN_BARGE_IN_MIN_SPEECH_CHUNKS = 10
